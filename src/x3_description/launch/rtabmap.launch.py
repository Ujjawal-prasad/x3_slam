...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('odom_frame_id',  default_value='odom/X3',                   description='If set, TF is used to get odometry instead of the topic.'),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/scan/points', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/odom/X3',  description='Odometry topic name.'),
        DeclareLaunchArgument('vo_frame_id',                default_value='x3/odom', description='Visual/Icp odometry frame ID for TF.'),
